export const projectData = [
  ...
  },
  {
    ...
    description:
      "A Lakos Ádám Evangélikus Szeretetszolgálat számára készítettem egy olyan weboldalt, ami a szervezet szolgáltatásait és működését mutatja be. Az oldal korábbi verziójához képest előrelépés volt a reszponzív design, amire szükség is volt mivel a mobil eszközök teszik ki a felhasználói megkeresések felét. Az oldal jelenleg elfogadásra vár, ezért egyenlőre nem tudok éles verziót mutatni belőle.",
    deploy_link: "",
    github_link: "",
  },
  {
    ...
    description:
      "Egy korábbi projektem, az edző termi oldal újragondolása volt. Az oldalon megjelenő információk és vizuális elemek részletesebbek lettek, valamint animációkkal is igyekeztem feldobni az oldal megjelenését. ",
  ...
  },
  {
    ...
    deploy_link:
      "https://www.figma.com/file/Beea2o9ud1XK6aokjDSzp6/Bikeshop-Landing-Page?node-id=0%3A1",
    github_link: "",
  },
  {
    id: 6,
    ...
    deploy_link: "https://kristof-portfolio-2.netlify.app/",
    github_link: "https://github.com/Gkristof96/Portfolio_v3",
  },
  {
    id: 7,
    name: "Portfolio v1",
